...
@XmlRootElement(name = "GetTimelineByHsaIdentity")
public class GetTimelineByHsaIdentity {

    @XmlElementRef(name = "hsaIdentity", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
